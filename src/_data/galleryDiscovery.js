...
const occasionItems = [
  ...
  [
    "first-birthday-boy",
    occasions["first-birthday-boy"].name,
    "occasions",
    "first-birthday-boy",
  ],
  [
    "first-birthday-girl",
    occasions["first-birthday-girl"].name,
    "occasions",
    "first-birthday-girl",
  ],
  [
    "bridal-shower",
    occasions["bridal-shower"].name,
    "occasions",
    "bridal-shower",
  ],
  ...
  [
    "baby-announcement",
    occasions["baby-announcement"].name,
    "occasions",
    "baby-announcement",
  ],
];
